...
ax1.pie(values, explode=explode, labels=label, autopct='%1.1f%%',
        shadow=True, startangle=75)
ax1.axis('equal')
plt.title("Percentual de pontualidade das viagens por empresa", fontsize=20, bbox={'facecolor':'0.8', 'pad':5})
plt.show()
